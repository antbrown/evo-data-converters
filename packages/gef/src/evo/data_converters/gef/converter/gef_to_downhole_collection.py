...
class DownholeCollectionBuilder:
    ...
    def process_cpt_file(self, hole_index: int, hole_id: str, cpt_data: CPTData) -> None:
        ...
        Args:
            hole_index: Sequential index for this hole
            hole_id: Unique identifier for this hole
            cpt_data: Parsed CPT data object
        """
    ...
    def build(self) -> DownholeCollection:
        ...
        Returns:
            Completed DownholeCollection object

        Raises:
            ValueError: If EPSG code was not set during processing
        """
    ...
    def _extract_epsg_code(self, cpt_data: CPTData, hole_id: str) -> int | str:
        ...
        Args:
            ...
            hole_id: Hole identifier for error messages

        Returns:
            EPSG code as int, or "unspecified" string

        Raises:
            ValueError: If EPSG code is missing or malformed
        """
        try:
    ...
    def _validate_and_set_epsg(self, cpt_data: CPTData, hole_id: str) -> None:
        ...
        Raises:
            ValueError: If EPSG codes are inconsistent across files
        """
    ...
    def _validate_epsg_code(self) -> None:
        ...
        Raises:
            ValueError: If no EPSG code was set
        """
        if self.epsg_code is None:
    ...
    def _validate_location_attributes(self, cpt_data: CPTData, hole_id: str) -> None:
        ...
        Raises:
            ValueError: If x or y location attributes are missing
        """
        try:
    ...
    def _calculate_final_depth(self, cpt_data: CPTData, hole_id: str) -> float:
        ...
        Raises:
            ValueError: If depth cannot be determined
        """
    ...
    def _create_collar_row(self, hole_index: int, hole_id: str, cpt_data: CPTData) -> dict[str, typing.Any]:
        ...
        Returns:
            Dictionary containing collar data and attributes
        """
    ...
    def _prepare_measurements(self, hole_index: int, cpt_data: CPTData) -> pl.DataFrame:
        ...
        Returns:
            Polars DataFrame with measurements
        """
    ...
    def _apply_nan_values_to_measurements(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        Args:
            df: The dataframe containing all measurements
        """
    ...
    def _create_collars_dataframe(self) -> pd.DataFrame:
        ...
        Returns:
            Pandas DataFrame with typed collar data
        """
    ...
    def _create_measurements_dataframe(self) -> pd.DataFrame:
        ...
        Returns:
            Pandas DataFrame with all measurements
        """
    ...
    def _create_collection(
        ...
        Args:
            ...
            collars_df: DataFrame with collar data
